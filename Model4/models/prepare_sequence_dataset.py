"""Generate the Model4 sequence dataset from the balanced tabular source dataset."""
...
from Model4.models.model4_utils import ensure_model4_directories, load_and_validate_dataset, save_json  # noqa: E402
...
LOGGER = logging.getLogger("Model4SequencePrep")


def prepare_sequence_dataset() -> Dict[str, object]:
    """Create and save the Model4 temporal sequence dataset."""
    ensure_model4_directories()
    df, dataset_report = load_and_validate_dataset(DATASET_PATH)
    LOGGER.info("Generating Model4 sequence dataset from balanced source data.")
...
def main() -> None:
    """Entry point for preparing the Model4 sequence dataset."""
