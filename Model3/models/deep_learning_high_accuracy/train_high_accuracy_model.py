...
from Model3.models.deep_learning_high_accuracy.high_accuracy_architecture import (  # noqa: E402
    build_high_accuracy_cnn_bilstm,
)
from Model3.models.deep_learning_high_accuracy.high_accuracy_utils import (  # noqa: E402
    build_callbacks,
...
SCALER_PATH = MODEL_ROOT / "outputs" / "high_accuracy_sequence_scaler.pkl"
MODEL_PATH = MODEL_ROOT / "outputs" / "high_accuracy_cnn_bilstm_model.h5"
RESULTS_PATH = MODEL_ROOT / "outputs" / "high_accuracy_model_results.json"
